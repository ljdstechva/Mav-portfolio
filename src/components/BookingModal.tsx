...
function BookingFrame() {
  ...
  return (
    <div className="flex-1 bg-white relative">
      {showLoading && (
        <div className="absolute inset-0 z-10 flex items-center justify-center bg-sand/10">
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-white w-full max-w-4xl h-[85vh] rounded-3xl overflow-hidden shadow-2xl flex flex-col pointer-events-auto relative">

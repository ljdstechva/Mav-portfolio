...
export default function TiltedCard({
  ...
  // Spotlight Effect
  const spotlight = useMotionTemplate`radial-gradient(circle at ${x}px ${y}px, rgba(236, 72, 153, 0.4), transparent 80%)`;
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 rounded-[4px] bg-white px-[10px] py-[4px] text-[10px] text-[#2d2d2d] opacity-0 z-[3] hidden sm:block border border-gray-200 shadow-lg"
          style={{
            x,
            y,
            opacity,

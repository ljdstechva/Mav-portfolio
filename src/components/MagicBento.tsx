...
export const MagicCard: React.FC<{
  ...
  const animateParticles = useCallback(() => {
    ...
    memoizedParticles.current.forEach((particle, index) => {
      ...
      // Use Number() to ensure compatibility with useRef<number[]>
...
export const GlobalSpotlight: React.FC<{
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      const section = gridRef.current; // Changed from .closest('.bento-section') to just the ref
...
export const MagicStyles = ({ glowColor = DEFAULT_GLOW_COLOR }: { glowColor?: string }) => (
  <style>
    {`
